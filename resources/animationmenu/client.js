...
const DanceMenu = new NativeUI.Menu("Dance", "Dance:", new NativeUI.Point(50, 50));
...
const AnimationMenu = new NativeUI.Menu("Animation", "Animation:", new NativeUI.Point(50, 50));
